    ...
    <div className='bg-black w-screen h-screen font-[Alan Sans]' >
      <nav className='text-white  border-b-1px  border-[#f1eaea1e] border-b p-6.5 px-10 sticky top-0 w-full   '>
        <ul className='flex flex-row justify-between'>
          ...
          <li><button className='bg-[#1f1f1f] text-lg px-4 border border-white p-2 rounded-xl '> <Link to="/Signup" className='hover:bg-[#1f1f1f]' >Sign up</Link></button></li>
        </ul>
      </nav>
      <div className='flex justify-center gap-2 items-center '>
        <div className=' text-white flex flex-col gap-3'>
          <form className='flex flex-col gap-3 '>
            ...
            <input type="email" placeholder='Email Address' className=' bg-[#1f1f1f] text-xl p-5 w-sm rounded-2xl' />
